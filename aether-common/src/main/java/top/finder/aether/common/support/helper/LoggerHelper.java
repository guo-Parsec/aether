...
public class LoggerHelper {
    ...
    static {
        LOG_MAP.put(Level.TRACE, LoggerHelper::trace);
        LOG_MAP.put(Level.DEBUG, LoggerHelper::debug);
        LOG_MAP.put(Level.INFO, LoggerHelper::info);
        LOG_MAP.put(Level.WARN, LoggerHelper::warn);
        LOG_MAP.put(Level.ERROR, LoggerHelper::error);
    }
